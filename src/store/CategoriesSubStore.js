  ...
  getAllCategory = async () => {
    ...
    //  console.log('===============>r', index);
      ...
      if (
        ...
        console.log('===============>r', index);
        this.navigation.push('CATEGORIES', { 
...
const categoriesSubStore = new CategoriesSubStore();

export const categoriesSubStoreContext = React.createContext(categoriesSubStore);
export const useCategoriesSubStore = () =>
  React.useContext(categoriesSubStoreContext);
