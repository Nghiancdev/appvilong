...
const CtvIntroduceScreen = observer(({route, navigation}) => {
  const windowWidth = Dimensions.get('window').width;
  const windowHeight = Dimensions.get('window').height;
  const {getAllCollaborator, ctvRetroduce, isLoading, loadInit} = useCtvStore();
...
export default CtvIntroduceScreen;
