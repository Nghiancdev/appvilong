...
import {useOrderAgencyStore} from '../../../../store/OrderAgencyStore';

const OrderAgencyScreen = observer(({route, navigation}) => {
  const {getAllOrderDeboucer, getAllOrder} = useOrderAgencyStore();
...
export default OrderAgencyScreen;
