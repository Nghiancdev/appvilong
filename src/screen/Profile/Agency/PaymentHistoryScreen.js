...
const PaymentHistoryAgencyScreen = observer(({ route, navigation }) => {
  const windowWidth = Dimensions.get('window').width;
  const windowHeight = Dimensions.get('window').height;
  const { getPaymentCtvHistory, history, isLoading, loadInit } = useAgencyStore();
...
export default PaymentHistoryAgencyScreen;
