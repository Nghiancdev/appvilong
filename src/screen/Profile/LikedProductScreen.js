...
const LikedProductScreen = observer(({route, navigation}) => {
  const windowWidth = Dimensions.get('window').width;
  const windowHeight = Dimensions.get('window').height;
  const {productsPurcharsed, isLoadingProduct, loading, getAllFavorite} =
    useProductStore();
  ...
  return (
    <Scaffold
      appbar={<IAppBar title={'Sản phẩm yêu thích'}></IAppBar>}
      body={
        loading == true ? (
